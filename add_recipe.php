    ...
    <div class="container">
        ...
        <div class="step" id="step1" <?php if ($step != 1) echo 'style="display: none;"'; ?>>
            ...
            <div class="form-group">
                ...
                <input type="file" id="file" name="file" class="form-control-file" onchange="checkFileSize(this)">
            </div>
            <div id="fileSizeError" style="color: red; display: none;">Please choose a smaller file.</div>
